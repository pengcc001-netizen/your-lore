      ...
      <footer style={{ borderTop: '1px solid var(--border)', background: 'var(--bg-elevated)', padding: '56px 24px 32px', marginTop: 64 }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ marginTop: 32, marginBottom: 24 }}>
            <div style={{ fontWeight: 600, fontSize: 11, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-soft)', marginBottom: 8, fontFamily: 'var(--font-body)' }}>Network Sites</div>
