  ...
  return (
    <div className="fade-in" style={{ maxWidth: 680, margin: '0 auto' }}>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "Article", "headline": `${archetype.name} —Character Archetype`, "description": archetype.tagline, "url": url, "author": { "@type": "Person", "name": "Elena Marchetti" }, "publisher": { "@type": "Organization", "name": "Your Lore" }, "datePublished": "2026-07-01", "mainEntityOfPage": url })}</script>
